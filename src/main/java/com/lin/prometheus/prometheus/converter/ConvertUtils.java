...
import com.lin.prometheus.prometheus.converter.query.QueryDataType;
                            ...
                            if("activeTargets".equals(_propertyName)) {
                                ...
                                while(reader.hasNext()) {
                                    ...
                                    while(reader.hasNext()) {
                                        ...
                                        }else if ("scrapePool".equals(__propertyName)){
                                            targetResultItem.setScrapePool(reader.nextString());
                                        }else if ("globalUrl".equals(__propertyName)){
                                            targetResultItem.setGlobalUrl(reader.nextString());
                                        }else if ("lastScrapeDuration".equals(__propertyName)){
                                            targetResultItem.setLastScrapeDuration(reader.nextString());
                                        } else if ("scrapeInterval".equals(__propertyName)){
                                            targetResultItem.setScrapeInterval(reader.nextString());
                                        } else if ("scrapeTimeout".equals(__propertyName)){
                                            targetResultItem.setScrapeTimeout(reader.nextString());
                                        }
                                    }
                                    reader.endObject();
